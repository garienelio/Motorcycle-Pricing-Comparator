...
class PowersportstoSpider(scrapy.Spider):
    name = "powersportsto"
    allowed_domains = ["powersportsto.com"]
    

    def start_requests(self):
        url = 'https://www.powersportsto.com/default.asp?category=motorcycle%20%2F%20scooter&page=xAllInventory&pg=1&sz=50'
    ...
    def parse(self, response):
        ...
        for motor in motors:
            ...
            load.add_value('url', 'https://www.powersportsto.com' + url)
