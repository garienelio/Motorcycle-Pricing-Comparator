...
class PeakpowerSpider(scrapy.Spider):
    name = "peakpower"
    allowed_domains = ["peakpowersportsoakville.ca"]
    # custom_settings = {
    #     'ITEM_PIPELINES' : {
    ...
    def start_requests(self):
        url = 'https://www.peakpowersportsoakville.ca/default.asp?category=motorcycle%20%2F%20scooter&page=xAllInventory&pg=1&sz=50'
    ...
    def parse(self, response):
        ...
        for motor in motors:
            ...
            load.add_value('url', 'https://www.peakpowersportsoakville.ca' + url)
